...
class EditProductSearch extends StatefulWidget {
  Products product;
  String slug;
  List<Images> images;
  @override
  _EditProductSearchState createState() => _EditProductSearchState(item: this.product,images:this.images,slug: this.slug);
  EditProductSearch(Products response,List<Images> images)
  {
...
class _EditProductSearchState extends State<EditProductSearch> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  Products item;
  String slug;
  List<String> tags = [];
  List<Images> images;
  _EditProductSearchState({ this.item, this.images,this.slug}) ;
...
// category,name,description,stock,default_price,current_price,tags,min_quantity,stock_alert_quantity,imageFile,manufacturer_id,specifications
          ...
          ApiCall()
            ...
            //   context,
            //   MaterialPageRoute(builder: (context) => TestProducts()),
            // );
...
// replace this function with the examples above
  ...
  String getSpecificationName(element)  {
  ...
  String getSpecificationId(element)  {
    if(item.specifications==null)
