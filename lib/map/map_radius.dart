...
class MapRadiusCircle extends StatefulWidget {
  final MapRadius mapRadius;
  MapRadiusCircle({Key key, @required this.mapRadius}) : super(key: key);
  @override
  State<MapRadiusCircle> createState() => _MapRadiusState();
}

class _MapRadiusState extends State<MapRadiusCircle> {
  ...
  void initState() {
    super.initState();
    _latitude = widget?.mapRadius?.lat ?? _latitude;
    _longitude = widget?.mapRadius?.long ?? _longitude;
